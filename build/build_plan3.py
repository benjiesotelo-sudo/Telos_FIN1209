#!/usr/bin/env python3
"""Build the FIN1209 Chapter 3 run card as a print-ready PDF.

    .venv/bin/python build/build_plan3.py

This is the instructor's document. The student-facing lecture notes are a
separate artifact, built by build/build_lecture_notes3.py.

Content is data in build/plan_chapter03.py. Layout is build/notekit.py, which
...
After building, look at the result. Every page:
    ...
    $DATA/pdfpng chapter-03/FIN1209-Chapter-03-Run-Card.pdf /tmp/card \
        $(seq 1 3)
...
from plan_chapter03 import PLAN  # noqa: E402

REPO = Path(__file__).resolve().parent.parent
PDF_OUT = REPO / "chapter-03" / "FIN1209-Chapter-03-Run-Card.pdf"
