...
| `activity/FIN1209-Chapter-01-Activity-1-Answer-Key.pdf` | The instructor | 24 pages. Every answer, the 24 marks and the written-answer rubric, and the reveal. | `build/activity_chapter01.py` |
