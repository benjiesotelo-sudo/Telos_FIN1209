#!/usr/bin/env python3
"""Build the FIN1209 Chapter 2 student lecture notes as a print-ready PDF.
...
The teaching copy, with the artwork, goes outside the repository:
    ...
    .venv/bin/python build/build_lecture_notes2.py --with-figures \\
        --out ~/FIN1209-Chapter-02-Lecture-Notes.pdf

After building, look at the result. Every page:

    DATA=/Users/benjie/benjie-agent-workspace/data/fin1209-notes-rebuild
    $DATA/pdfpng chapter-02/FIN1209-Chapter-02-Lecture-Notes.pdf /tmp/ln \\
        $(seq 1 18)
...
from charts_chapter02 import CHARTS  # noqa: E402
from content_chapter02 import CHAPTER  # noqa: E402
from lecture_chapter02 import NOTES  # noqa: E402

REPO = Path(__file__).resolve().parent.parent
PDF_OUT = REPO / "chapter-02" / "FIN1209-Chapter-02-Lecture-Notes.pdf"
...
CHARTS_DIR = REPO / "build" / "generated" / "charts-02"
...
SUMMARY_SLIDE = "Chapter 2 in five sentences"
...
def deck_closing(chapter) -> tuple[tuple[str, ...], tuple[str, ...]]:
    ...
    if missing:
        raise SystemExit(
            ...
            "and in build_lecture_notes2.py together."
        )
...
def main() -> int:
    ...
    if args.with_figures and not args.figures_dir.is_dir():
        parser.error(
            ...
            "repository; see chapter-02/README.md. Drop the flag to build the "
            "placeholder version."
        )
